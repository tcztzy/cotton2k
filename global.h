...
extern double AbscissionLag[20], ActualRootGrowth[maxl][maxk],
    ...
    DewPointTemp[24], dl[maxl], ElCondSatSoil[20], es1hour[24], es2hour[24],
    ...
    LeafWeightPreFru[9], LightInterceptLayer[20], LevelsOfWaterTable[20],
    LwpMinX[3], LwpX[3], MarginalWaterContent[maxl], MapDataAllSiteNum[30],
