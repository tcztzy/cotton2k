...
typedef struct scratch
{
        ...
        double amitri, averageSoilPsi, avrgDailyTemp, burrNConc, burrWeightOpenBolls,
            ...
            nStressRoots, nStressVeg,
            petioleNConc, petioleNO3NConc, petioleNitrogen, plantWeight,
            reserveC, rootNConc, rootNitrogen, rootWeightLoss,
...
extern double ActualBollGrowth, ActualBurrGrowth,
    ...
    ElCondSatSoilToday, ExtraCarbon, FruitGrowthRatio, ginp, Gintot, GreenBollsLost,
    ...
    RatioImplicit, ReserveC, RootNConc, RootNitrogen, RootWeightLoss,
...
extern double AbscissionLag[20], AgeOfPreFruNode[9], airdr[9],
    ...
    DefoliantAppRate[5], DelayNewFruBranch[3],
    dl[maxl], ElCondSatSoil[20],
