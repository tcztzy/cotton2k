...
DailyOutput(const std::string &, const std::string &, const int &, const int &, const int &, const int &, const int &,
            ...
            const double[40][20][3], const double[40][20], const Climstruct[400]);

void
DataOutput(const string &, const int &, const int &, const int &, const int &, const int &, const int &, const int &,
           double);
