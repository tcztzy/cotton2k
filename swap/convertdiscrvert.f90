! File VersionID:
!   $Id: convertdiscrvert.f90 298 2016-07-25 20:07:31Z kroes006 $
! ----------------------------------------------------------------------
...
! - Bug fixed: Rob H 28 okt 2011  !  this output for tabulated soil physics is suppressed
            ...
            hNew(node) = prhead (node,disnodNew(node),cofgenNew,        &
     &               thetaNew(node),hNew,swsophy,numtab,sptab,ientrytab)
          enddo
