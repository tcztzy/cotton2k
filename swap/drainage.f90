! File VersionID:
!   $Id: drainage.f90 325 2017-03-16 15:59:06Z kroes006 $
! ----------------------------------------------------------------------
...
! --- global
      ...
      integer swmacro,NumLevRapDra,swliminf
