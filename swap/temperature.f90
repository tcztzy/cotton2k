! File VersionID:
!   $Id: temperature.f90 326 2017-04-22 10:52:23Z kroes006 $
! ----------------------------------------------------------------------
...
!     
      real(8) GQuartz,GClay,GWat,GAir,GOrg,GAirdry
      Parameter (GQuartz = 0.14d0, GClay = 0.125d0 , GWat = 0.14d0,     &
     &           GOrg = 0.5d0)
!     (iii.ii) theta 0.02, 0.05 and 1.00                               
      real(8) thetaDry,thetaWet
