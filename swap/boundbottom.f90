! File VersionID:
!   $Id: boundbottom.f90 298 2016-07-25 20:07:31Z kroes006 $
! ----------------------------------------------------------------------
...
! --- interpolation between daily values of given pressurehead
      if (swbotb .eq. 5) then
        ...
        thetabot = watcon(numnod,hbot,cofgen,swsophy,numtab,sptab,      &
     &                    ientrytab)
                   
        kmean(numnod+1)= hconduc(numnod,hbot,thetabot,cofgen,swfrost,   &
     &                  rfcp(numnod),swsophy,numtab,sptab,ientrytab)
