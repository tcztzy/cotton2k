...
tuple<int, double> PlantGrowth(const string&, const string&, const int&, const int&, const int&, const int&, const int&, int, const int&, double, const double&, const double&, const double&, double[40][20][3], double[40][20]);
