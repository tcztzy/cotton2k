...
extern double ActualBollGrowth, ActualBurrGrowth,
    ...
    InitialTotalSoilWater, IrrigationDepth, LeafNitrogen,
    LightIntercept, LwpMax, LwpMin, MaxIrrigation, MineralizedOrganicN,
    NetPhotosynthesis, NightTimeTemp, NStressFruiting, NStressRoots,
    PercentDefoliation, PetioleNitrogen, PetioleNO3NConc,
    PlantPopulation, PlantRowLocation, PotGroAllBolls, PotGroAllBurrs,
    ...
    SeedNitrogen, SoilNitrogenLoss, SquareNConc,
