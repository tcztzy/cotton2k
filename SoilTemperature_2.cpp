...
void SoilMulchBalance(int, int, double, double, double, double, double &, double &, double &, double, double &, double,
                      double, const int &, const double &);

void SoilSurfaceBalance(int, int, double, double, double, double, double, double &, double &, double &, double, double,
                        double, const int &, const double &);
...
//
//     The following global variables are referenced here:
//       dl, MulchTranLW, VolWaterContent.
...
//     Energy balance for mulch (soil and air interface)
        hsgm = 2 * rocp * fabs(so - tm);
        MulchSurfaceBalance(ihr, k, rlsp, rls5, rsm, sf, hsgp, hsgm, so, thet, tm, tv, Daynum);
