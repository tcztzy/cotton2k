...
//        TotalLeafArea, TotalLeafWeight, TotalPetioleWeight, TotalStemWeight.
{
    ...
    sumpdr = PotentialRootGrowth(NumRootAgeGroups, NumLayersWithRoots, sim.num_curve, sim.states[DayOfSimulation - 1].root, sim.root_age);
    ...
    tie(NumLayersWithRoots) = ComputeActualRootGrowth(sumpdr, sim, Daynum, DayOfSimulation, sim.day_emerge,
                                                      NumLayersWithRoots, NumRootAgeGroups, sim.root_age);
