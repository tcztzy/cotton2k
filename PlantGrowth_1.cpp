...
//     Call ActualRootGrowth() to compute actual root growth.
      tie(NumLayersWithRoots) = ComputeActualRootGrowth(sumpdr, ProfileName, Daynum, DayOfSimulation, DayEmerge, NumLayersWithRoots, NumRootAgeGroups, RootWeight, RootAge);
