//! Soil nitrogen mineralization, nitrification, denitrification, and balance.
//!
//! The public routines transform water, temperature, organic-matter, and
//! fertilizer state into updated ammonium/nitrate/urea pools in the legacy soil
//! grid. They mutate shared simulation state, return no external data, and must
//! run after the relevant daily water and temperature phases.
...
/// Advances daily soil nitrogen transformations in the active grid.
...
/// Computes the soil nitrogen balance diagnostics for the current day.
...
/// Computes layer-averaged soil nitrogen diagnostics.
