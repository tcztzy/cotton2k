//! Low-level heat-transfer equations for soil, canopy, and mulch surfaces.
//!
//! These routines implement the thermal exchange equations used by soil
//! thermodynamics. They receive scalar or legacy-state inputs and return heat
//! fluxes or update the synchronized state; they perform no I/O and assume the
//! caller has established valid layer, column, and hourly bounds.
