//! Cotton phenology, node initiation, flowering, and boll development.
//!
//! [`cotton_phenology`] advances development from climate and plant stress,
//! creating branches, nodes, fruiting sites, and opening bolls in legacy state.
//! It is a deterministic daily state transition with no I/O and must follow the
//! plant nitrogen and physiological-age setup performed by the engine.
...
/// Advances branches, nodes, fruiting sites, and boll development by one day.
