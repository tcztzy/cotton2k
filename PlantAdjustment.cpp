...
tuple<string, int, int, double, double, double> GoBack(const string&, const int&, int, double, double, double, double[40][20][3], double[40][20]);

///////////////////////////////////////////////////////////////////////////////////////////////////
void WriteStateVariables(bool bAdjusting, const string& Date, const int& Daynum, const int& NumLayersWithRoots, const double& PlantHeight, const double& AbscisedFruitSites, const double& AbscisedLeafWeight, const double RootWeight[40][20][3], const double RootAge[40][20])
...
//////////////////////////
tuple<string, int, int, double, double, double> PlantAdjustments(int i, int jj, const string& ProfileName, const string& Date, const int& daynum, int NumLayersWithRoots, double PlantHeight, double AbscisedFruitSites, double AbscisedLeafWeight, double RootWeight[40][20][3], double RootAge[40][20])
...
//  5 - for open boll number.
     ...
     case 0:   // adjust the number of main stem nodes
         if (MapDataMainStemNodes[i] <= 0)
                return make_tuple(date, Daynum, NumLayersWithRoots, PlantHeight, AbscisedFruitSites, AbscisedLeafWeight);
...
//     AdjAddMSNodesRate will be used in function AddFruitingBranch()
             ...
             tie(date, Daynum, NumLayersWithRoots, PlantHeight, AbscisedFruitSites, AbscisedLeafWeight) = GoBack(date, Daynum, NumLayersWithRoots, PlantHeight, AbscisedFruitSites, AbscisedLeafWeight, RootWeight, RootAge);
         }
         return make_tuple(date, Daynum, NumLayersWithRoots, PlantHeight, AbscisedFruitSites, AbscisedLeafWeight);
//
...
///////////////////////////////////////////////////////////////////////
tuple<string, int, int, double, double, double> GoBack(const string& Date, const int& daynum, int NumLayersWithRoots, double PlantHeight, double AbscisedFruitSites, double AbscisedLeafWeight, double RootWeight[40][20][3], double RootAge[40][20])
...
//
{
	     ...
	     if (Kday <= NumAdjustDays)
	            return make_tuple(date, Daynum, NumLayersWithRoots, PlantHeight, AbscisedFruitSites, AbscisedLeafWeight);  // before emergence
