...
//////////////////////////
tuple<string, int, int, int, int, double, double, double, double>
PlantAdjustments(int i, int jj, const string &ProfileName, const string &Date, const int &daynum,
                 const int &DayOfSimulation, int FirstBloom, int FirstSquare, int NumLayersWithRoots,
    ...
    switch (jj) {
        case 0:   // adjust the number of main stem nodes
            if (MapDataMainStemNodes[i] <= 0)
                return make_tuple(date, Daynum, FirstBloom, FirstSquare, NumLayersWithRoots, PlantHeight,
...
//     AdjAddMSNodesRate will be used in function AddFruitingBranch()
                ...
                tie(date, Daynum, FirstBloom, FirstSquare, NumLayersWithRoots, PlantHeight, AbscisedFruitSites,
                    AbscisedLeafWeight, WaterStress) = GoBack(date, Daynum, DayOfSimulation, FirstBloom, FirstSquare,
                                                              NumLayersWithRoots, PlantHeight, AbscisedFruitSites,
                                                              AbscisedLeafWeight, WaterStress, RootWeight, RootAge);
            }
            return make_tuple(date, Daynum, FirstBloom, FirstSquare, NumLayersWithRoots, PlantHeight,
                              AbscisedFruitSites, AbscisedLeafWeight, WaterStress);
//
