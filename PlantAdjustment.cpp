...
tuple<string, int, double> GoBack(const string&, const int&, double);

///////////////////////////////////////////////////////////////////////////////////////////////////
void WriteStateVariables(bool bAdjusting, const string& Date, const int& Daynum, const double& PlantHeight)
...
//////////////////////////
tuple<string, int, double> PlantAdjustments(int i, int jj, const string& ProfileName, const string& Date, const int& daynum, double PlantHeight)
...
//  5 - for open boll number.
     ...
     case 0:   // adjust the number of main stem nodes
         if (MapDataMainStemNodes[i] <= 0)
                return make_tuple(date, Daynum, PlantHeight);
...
//     AdjAddMSNodesRate will be used in function AddFruitingBranch()
             ...
             tie(date, Daynum, PlantHeight) = GoBack(date, Daynum, PlantHeight);  
         }
         return make_tuple(date, Daynum, PlantHeight);
//
...
///////////////////////////////////////////////////////////////////////
tuple<string, int, double> GoBack(const string& Date, const int& daynum, double PlantHeight)
...
//
{
	     ...
	     if (Kday <= NumAdjustDays)
	            return make_tuple(date, Daynum, PlantHeight);  // before emergence
