import unittest
import datetime
from cotton2k.io import parse_profile, parse_profile_carbon_dioxide, parse_profile_description, parse_profile_field, parse_profile_geometry, parse_profile_output_flags, parse_profile_output_options, parse_profile_parameter_files, parse_profile_simulation_dates, parse_profile_weather
...
class ProfileFileTestCase(unittest.TestCase):
    ...
    def test_parameter_files(self):
        result = parse_profile_parameter_files("HAZOR.HYD           HAZOR.INT           HAKB1.AGI                               ")
    ...
    def test_output_options(self):
        result = parse_profile_output_options("        10    20-APR-1984    20-SEP-1984        10    01-JUN-1984    20-SEP-1984    ")
