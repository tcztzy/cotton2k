...
public:
	...
	tuple<string, int, int, int, int, int, double, double, double, double> SimulateThisDay(const string&, const int&, int, const int&, const int&, const int&, int, int, int, double, double, double, double, double[40][20][3], double[40][20]);
    tuple<BOOL, string, int, int, int, int, int, int, double, double, double, double> DoAdjustments(const string&, string, int, int, int, const int&, const int&, const int&, int, int, int, double, double, double, double, double[40][20][3], double[40][20]);
