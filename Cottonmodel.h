...
public:
	...
	tuple<string, int, int, int, double, double, double> SimulateThisDay(string, const int&, int, const int&, const int&, const int&, int, double, double, double, double[40][20][3], double[40][20]);
