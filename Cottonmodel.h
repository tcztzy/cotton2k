...
public:
    ...
    void RunTheModel();
	tuple<string> DailySimulation(string ProfileName, const string& Date, const int& DayStart, const int& DayFinish);
	tuple<string> SimulateThisDay(string ProfileName, const int& DayStart, const int& DayFinish);
    tuple<BOOL, string> DoAdjustments(string ProfileName, const string& Date, const int& DayStart, const int& DayFinish);
