...
tuple<int, int, int, int, int, int, int, int, int, int, double, double, double, string, string, string, string, string, string> ReadProfileFile(const string&);
void ReadCalibrationData();
void InitializeGrid();
void WriteInitialInputData(const string&, const string&, const string&, const string&, const string&, const string&, const string&, const int&, const int&, const int&, const int&, const int&, const int&, const int&, const int&, const double&, const double&, const double&);
// GettingInput_2
...
/////////////////////////////////////////////////////////////
tuple<int, int, int, int, int, int, int, int, int, int, double, double, double> ReadInput(const string& ProfileName, double RootWeight[40][20][3], double RootAge[40][20])
...
//  input files, or initialize them otherwise.
    int
        ...
        DayPlant,
        DayStartSoilMaps,
        DayStopSoilMaps, DayStartCO2, DayEndCO2, DayStartMulch, DayEndMulch;
    string
    ...
    double
        ...
        Longitude;
	InitializeGlobal();
	tie(DayEmerge, DayStart, DayFinish, DayPlant, DayStartSoilMaps, DayStopSoilMaps, DayStartCO2, DayEndCO2, DayStartMulch, DayEndMulch, CO2EnrichmentFactor, Latitude, Longitude, ActWthFileName, PrdWthFileName, SoilHydFileName, SoilInitFileName, AgrInputFileName, PlantmapFileName) = ReadProfileFile(ProfileName);
	ReadCalibrationData();
	LastDayOfActualWeather = OpenClimateFile(ActWthFileName, PrdWthFileName, DayStart);
	InitializeGrid();
	ReadSoilImpedance();
    WriteInitialInputData(ProfileName, ActWthFileName, PrdWthFileName, SoilHydFileName, SoilInitFileName, AgrInputFileName, PlantmapFileName, DayEmerge, DayStart, DayFinish, DayPlant, DayStartCO2, DayEndCO2, DayStartMulch, DayEndMulch, CO2EnrichmentFactor, Latitude, Longitude);
...
//     initialize some variables at the start of simulation.
    ...
    return make_tuple(DayEmerge, DayStart, DayFinish, DayPlant, DayStartSoilMaps, DayStopSoilMaps, DayStartCO2, DayEndCO2, DayStartMulch, DayEndMulch, CO2EnrichmentFactor, Latitude, Longitude);
}
/////////////////////////////////////////////////////////////////////////////
tuple<int, int, int, int, int, int, int, int, int, int, double, double, double, string, string, string, string, string, string> ReadProfileFile(const string& ProfileName)
...
//     Call function OpenOutputFiles() to open the output files.
      ...
      return make_tuple(DayEmerge, DayStart, DayFinish, DayPlant, DayStartSoilMaps, DayStopSoilMaps, DayStartCO2, DayEndCO2, DayStartMulch, DayEndMulch, CO2EnrichmentFactor, Latitude, Longitude, ActWthFileName, PrdWthFileName, SoilHydFileName, SoilInitFileName, AgrInputFileName, PlantmapFileName);
}
//////////////////////////////////////////////////////////
void ReadCalibrationData()
