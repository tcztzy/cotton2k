...
void output1(const string&, const string&, const int&, const int&, const int&, const int&, const double&, const double&);
...
////////////////////////////////////////////////////////////////////////////
void DailyOutput(const string& ProfileName, const string& Date, const int& Daynum, const int& DayOfSimulation, const int& DayEmerge, const int& DayFinish, const int& FirstBloom, const int& FirstSquare, const int& NumLayersWithRoots, const double& PlantHeight, const double& AbscisedFruitSites, const double& AbscisedLeafWeight, const double& WaterStress, const double RootWeight[40][20][3], const double RootAge[40][20])
...
//  this day in structure Scratch21, which will be used for output at the end of the simulation.
      if (DayOfSimulation > 0)
           WriteStateVariables(false, Date, Daynum, DayOfSimulation, FirstBloom, FirstSquare, NumLayersWithRoots, PlantHeight, AbscisedFruitSites, AbscisedLeafWeight, WaterStress, RootWeight, RootAge);
//
...
//////////////////////////
void output1(const string& ProfileName, const string& Date, const int& Daynum, const int& DayEmerge, const int& FirstBloom, const int& FirstSquare, const double& PlantHeight, const double& AbscisedFruitSites)
...
/////////////////////////////////////////////////////////////////////////////////////
void DataOutput(const string& ProfileName, const int& DayEmerge, const int& DayStart, const int& DayFinish, const int& DayStartSoilMaps, const int& DayStopSoilMaps, const int& FirstBloom, const int& FirstSquare, double PlantHeight)
