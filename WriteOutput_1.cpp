...
////////////////////////////////////////////////////////////////////////////
void DailyOutput(const string& ProfileName, const string& Date, const int& Daynum, const int& DayEmerge, const int& DayFinish, const int& NumLayersWithRoots, const double& PlantHeight, const double& AbscisedFruitSites, const double RootWeight[40][20][3], const double RootAge[40][20])
...
//  this day in structure Scratch21, which will be used for output at the end of the simulation.
      if (DayOfSimulation > 0)
           WriteStateVariables(false, Date, Daynum, NumLayersWithRoots, PlantHeight, AbscisedFruitSites, RootWeight, RootAge);
//
