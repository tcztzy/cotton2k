...
////////////////////////////////////////////////////////////////////////////
void DailyOutput(const string& ProfileName, const string& Date, const int& Daynum, const int& DayEmerge, const int& DayFinish, const int& NumLayersWithRoots, const double& PlantHeight, const double RootWeight[40][20][3])
...
//  this day in structure Scratch21, which will be used for output at the end of the simulation.
      if (DayOfSimulation > 0)
           WriteStateVariables(false, Date, Daynum, NumLayersWithRoots, PlantHeight, RootWeight);
//
